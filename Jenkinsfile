    ...
    stages {
        stage('Build Test Deploy') {
            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME python -c "import netCDF4; import numpy; import cartopy; import matplotlib; import pandas; import gdal; import proj"'
